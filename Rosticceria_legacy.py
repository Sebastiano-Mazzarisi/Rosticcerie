...
<head>
  ...
  <style>
    ...
    .audio-hint-text {{ display: none; line-height: 1.05; font-size: 12px; font-weight: bold; color: #00c853; text-align: right; margin-right: 2mm; }}
    ...
    .home-identity:not(.audio-playing) .sound-waves path {{ animation: none; opacity: 0.7; }}
    .home-identity:not(.audio-playing) .sound-waves path:nth-child(2) {{ transform: translateX(-12px) scaleY(1.4); }}
    .home-identity:not(.audio-playing) .sound-waves path:nth-child(3) {{ transform: translateX(-24px) scaleY(1.8); }}
